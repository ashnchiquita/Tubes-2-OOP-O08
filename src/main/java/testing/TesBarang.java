...
public class TesBarang {
    public static void main(String[] args) {
        ...
        Barang b1 = Barang.builder().id(1).name("ayam").kategori("a").gambar("hai").hargaJual(2).hargaBeli(3).jumlah(4).build();
        Barang b2 = Barang.builder().id(2).name("ayam").kategori("a").gambar("hai").hargaJual(3).hargaBeli(4).jumlah(5).build();
