...
//        Member c = Member.builder().id().name("ayam").phone("123").point(0).transactions(0).active(true).build();
//        Member c2 = Member.builder().id().name("ayam2").phone("1234").point(0).transactions(0).active(true).build();
//        VIP c = VIP.builder().id().name("ayam").phone("123").point(0).transactions(0).active(true).build();
//        VIP c2 = VIP.builder().id().name("ayam2").phone("1234").point(0).transactions(0).active(true).build();
...
//        controller.setMemberDataIO(new MemberAdapterJSON("src/main/resources/data/member.json"));
//        System.out.println("-------------------------");
//        System.out.println("Cust:" + Customer.count);
//        System.out.println("Member:" + Member.maxMemID);
//        System.out.println("VIP:" + VIP.maxVIPID);
//        controller.setVIPDataIO(new VIPAdapterJSON("src/main/resources/data/vip.json"));
//        System.out.println("-------------------------");
//        System.out.println("Cust:" + Customer.count);
//        System.out.println("Member:" + Member.maxMemID);
//        System.out.println("VIP:" + VIP.maxVIPID);
