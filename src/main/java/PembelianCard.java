...
public class PembelianCard extends RoundedPanel {
  String title, subtitle, price, imagePath;

  public PembelianCard(String title, String subtitle, String price, String imagePath) {
    ...
    // this.setBounds(100, 100, 156, 186);
    ...
    bottomContainer.setPreferredSize(new Dimension(156, 78));
