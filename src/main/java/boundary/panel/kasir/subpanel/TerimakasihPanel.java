...
public class TerimakasihPanel extends FlowablePane {
  ...
  private void initializeUI() {
    ...
    tambahButton.addActionListener(e -> panelFlowObserver.newEvent(new PanelFlowEvent(new CreateMemberPanel(), false)));
