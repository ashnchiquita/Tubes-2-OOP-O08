 ...
 */
package boundari.panel.settings;
...
public class Settings extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(boundari.panel.settings.Settings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new boundari.panel.settings.Settings().setVisible(true);
            }
        });
    }
